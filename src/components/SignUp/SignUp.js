...
return (
  <Container fluid className=" signup-card d-flex align-items-center justify-content-center">
    <Card >
      <Row >
        <Col md={6} className=" right-side d-flex flex-column justify-content-center align-items-center text-center ">
          <> <h2>Welcome Back!</h2>
            <p>To keep connected with us please login with your personal info</p>
            <Button type="submit" variant="light" onClick={() => navigate("/signin")} >SIGN IN</Button>
          </>
        </Col>
        <Col md={6} className="d-flex flex-column justify-content-center text-center mt-5 mb-5 ">
          <>
            ...
            <Form onSubmit={handleSubmit} noValidate className="mt-3">
              ...
              <Button type="submit" variant="danger" className="w-50">SIGN UP</Button>
            </Form>
            <p className="mt-3">
